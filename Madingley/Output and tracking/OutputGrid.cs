...
namespace Madingley
{
    ...
    class OutputGrid
    {
        ...
        private double[,] Temp;
        private double[,] TempNPP;
        private double[,] SDTemp;
        private double[,] DTR;
        private double[,] Precip;
        private double[,] NPP;
        private double[,] FracYearFrost;
        private double[,] FracYearFire;
        private double[,] AET;
        private double[,] AWC;
        private double[,] AnnualTemp;
            ...
            stockFunctionalGroupDefinitions)
        {
            ...
            TempNPP = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            SDTemp = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            DTR = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            Precip = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            NPP = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            FracYearFrost = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            FracYearFire = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            AET = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            AWC = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            AnnualTemp = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            FracEvergreen = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            Seasonality = new double[ecosystemModelGrid.NumLatCells, ecosystemModelGrid.NumLonCells];
            ...
            DataConverter.AddVariable(GridOutput, "TemperatureNPP", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "SDTemperature", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "DiurnalTemperatureRange", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "Precipitation", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "NPP", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            ...
            DataConverter.AddVariable(GridOutput, "Fraction year fire", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "AET", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "AWC", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "Annual temperature", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
            DataConverter.AddVariable(GridOutput, "Seasonality", 3, GeographicalDimensions, ecosystemModelGrid.GlobalMissingValue, outLats, outLons, TimeSteps);
        ...
        private void CalculateOutputs(ModelGrid ecosystemModelGrid, FunctionalGroupDefinitions cohortFunctionalGroupDefinitions,
            FunctionalGroupDefinitions stockFunctionalGroupDefinitions, List<uint[]> cellIndices, MadingleyModelInitialisation initialisation, uint currentMonth)
        {
            ...
            Temp = ecosystemModelGrid.GetEnviroGrid("Temperature", currentMonth);
            TempNPP = ecosystemModelGrid.GetEnviroGrid("TemperatureNPP", currentMonth);
            SDTemp = ecosystemModelGrid.GetEnviroGrid("SDTemperature", 0);
            DTR = ecosystemModelGrid.GetEnviroGrid("DiurnalTemperatureRange", currentMonth);
            Precip = ecosystemModelGrid.GetEnviroGrid("Precipitation", currentMonth);
            NPP = ecosystemModelGrid.GetEnviroGrid("NPP", currentMonth);
            FracYearFrost = ecosystemModelGrid.GetEnviroGrid("Fraction Year Frost", 0);
            FracYearFire = ecosystemModelGrid.GetEnviroGrid("Fraction Year Fire", 0);
            AET = ecosystemModelGrid.GetEnviroGrid("AET", 0);
            AWC = ecosystemModelGrid.GetEnviroGrid("AWC", 0);
            AnnualTemp = ecosystemModelGrid.GetEnviroGrid("AnnualTemperature", 0);
            Seasonality = ecosystemModelGrid.GetEnviroGrid("Seasonality", currentMonth);
        ...
        public void InitialOutputs(ModelGrid ecosystemModelGrid, FunctionalGroupDefinitions cohortFunctionalGroupDefinitions, FunctionalGroupDefinitions
            stockFunctionalGroupDefinitions, List<uint[]> cellIndices, MadingleyModelInitialisation initialisation, uint currentMonth)
        {
            Console.WriteLine("Writing initial grid outputs...");

            // Calculate the output variables
            CalculateOutputs(ecosystemModelGrid, cohortFunctionalGroupDefinitions, stockFunctionalGroupDefinitions, cellIndices, initialisation, currentMonth);
            ...
            DataConverter.Array2DToSDS3D(FracYearFrost, "Fraction year frost", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(FracEvergreen, "Fraction evergreen", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(Temp, "Temperature", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(TempNPP, "TemperatureNPP", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(SDTemp, "SDTemperature", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(DTR, "DiurnalTemperatureRange", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(Precip, "Precipitation", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(NPP, "NPP", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(FracYearFire, "Fraction year fire", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(AET, "AET", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(AWC, "AWC", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(AnnualTemp, "Annual temperature", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
            DataConverter.Array2DToSDS3D(Seasonality, "Seasonality", new string[] { "Latitude", "Longitude", "Time step" },
                0, ecosystemModelGrid.GlobalMissingValue, GridOutput);
