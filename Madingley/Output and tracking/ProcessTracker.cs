...
namespace Madingley
{
    ...
    public class ProcessTracker
    {
            ...
            float lonCellSize)
        {
            ...
            // Code for 'hacking' outputting of growth information for global simulations
        ...
        public void RecordNewCohort(uint latIndex, uint lonIndex, uint timestep, double offspringCohortAbundance, double offspringBodymass,
            double parentCohortAdultMass, int functionalGroup, List<uint> parentCohortIDs, uint offspringCohortID,
            double parentCohortAbundance)
        {
            _TrackReproduction.RecordNewCohort(latIndex, lonIndex, timestep, offspringCohortAbundance, offspringBodymass, parentCohortAdultMass, 
                functionalGroup,parentCohortIDs,offspringCohortID,parentCohortAbundance);
        }
        ...
        public void TrackTimestepGrowth(uint latIndex, uint lonIndex, uint timeStep, double currentBodyMass, 
            int functionalGroup, double netGrowth, double metabolism, double predation, double herbivory, double adultMass)
        {
            _TrackGrowth.RecordGrowth(latIndex, lonIndex, timeStep, currentBodyMass, functionalGroup, netGrowth, metabolism, predation,herbivory,adultMass);
        }
        ...
        {
            _TrackReproduction.FlushStreams();
            _TrackEating.FlushStreams();
            _TrackGrowth.FlushStreams();
            _TrackMetabolism.FlushStreams();
            _TrackMortality.FlushStreams();
