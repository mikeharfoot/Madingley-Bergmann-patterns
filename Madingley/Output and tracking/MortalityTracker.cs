...
namespace Madingley
{
    ...
    public class MortalityTracker
    {
            ...
            string outputPath, int cellIndex)
        {
            ...
            SyncMortalityWriter.WriteLine("Latitude\tLongitude\tbirth_step\ttime_step\tcurrent mass\tadult mass\tfunctional group\tcohort id\tnumber died\tmortality source\tcohort abundance");
