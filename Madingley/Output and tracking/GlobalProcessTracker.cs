...
namespace Madingley
{
    ...
    public class GlobalProcessTracker
    {
        ...
        /// <summary>
        /// Record a loss of biomass from plants from leaf mortality
        /// </summary>
        /// <param name="latIndex">The latitudinal index of the current grid cell</param>
        /// <param name="lonIndex">The longitudinal index of the current grid cell</param>
        /// <param name="val">The biomass lost through Leaf Mortality value</param>
        //public void RecordLeafMortality(uint latIndex, uint lonIndex, double val)
        //{
        //    _TrackNPP.RecordLeafMortValue(latIndex, lonIndex, val);
        //}
        ...
        /// <summary>
        /// Write out the Leaf Mortality-tracking data to file
        /// </summary>
        /// <param name="t">The current time step</param>
        //public void StoreLeafMortalityGrid(uint t)
        //{
        //    _TrackNPP.StoreLeafMortalityGrid(t);
        //}
