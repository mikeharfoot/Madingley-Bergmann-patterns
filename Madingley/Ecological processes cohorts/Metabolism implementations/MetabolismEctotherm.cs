...
namespace Madingley
{
    ...
    public partial class MetabolismEctotherm : IMetabolismImplementation
    {
        ...
        public void InitialiseMetabolismParameters()
        {
            ...
            _MetabolismMassExponent = 0.88;
            _NormalizationConstant = 1.4898373851E+11;
            _ActivationEnergy = 0.69; // includes endotherms in hibernation and torpor
            _BoltzmannConstant = 8.617e-5;

            // BMR normalisation constant from Brown et al 2004 - original units of J/s so scale to kJ/d
            _NormalizationConstantBMR = Math.Exp(20)*60*60*24/1000;
            _BasalMetabolismMassExponent = 0.69;
