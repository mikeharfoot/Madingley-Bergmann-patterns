...
namespace Madingley
{
    ...
    class RunSimulations
    {
        ...
        /// </summary>
        /// <param name="initialisationFilename">Filename of the file from which to read initialisation information</param>
        ...
        public void RunAllSimulations(string initialisationFilename, ScenarioParameterInitialisation scenarios, string outputPath)
        {
            // Declare an instance of the class for initializing the Madingley model
            MadingleyModelInitialisation InitialiseMadingley = new MadingleyModelInitialisation(initialisationFilename, outputPath);
